;;; rainbowdash-theme.el --- Rainbow Dash Theme

;; Author: 5heikki
;; Version: 0.1
;; Package-Requires: ((emacs "24"))
;; URL: https://github.com/sheikki/rainbowdash-theme
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(linum ((,class (:slant italic :foreground ,bg3 :background ,bg1))))
   ...
   `(diff-hl-delete ((,class (:foreground ,rainbow-8 :background ,rainbow-8))))
   ...
   `(gnus-group-mail-low ((,class (:foreground ,bg3 :bold t))))
   ...
   `(gnus-group-news-low ((,class (:foreground ,bg3 :bold t))))
   ...
   `(gnus-summary-normal-read ((,class (:foreground ,bg3 :weight normal))))
   ...
   `(jde-java-font-lock-modifier-face ((t (:foreground ,key2))))
   ...
   `(diredp-deletion-file-name ((,class (:foreground ,keyword :background ,bg3))))
   `(diredp-deletion ((,class (:foreground ,keyword :weight bold))))
   `(diredp-dir-heading ((,class (:foreground ,fg2 :background ,bg3))))
   ...
   `(diredp-flag-mark-line ((,class (:foreground ,fg2 :slant italic :background ,bg3))))
   `(diredp-flag-mark ((,class (:foreground ,fg2 :weight bold :background ,bg3))))
...
(provide-theme 'rainbowdash)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; rainbowdash-theme.el ends here
